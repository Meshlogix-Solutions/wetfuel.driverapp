...
export const routes: Routes = [
  ...
  { path: 'verification', loadComponent: () => import('./pages/verification.page').then(m => m.VerificationPage) },
  {
    ...
    children: [
      ...
      { path: 'jobs/:jobId/delivery-proof', canActivate:[jobWorkflowGuard], data:{statuses:['fueling']}, loadComponent: () => import('./pages/delivery_proof.page').then(m => m.DeliveryProofPage) },
