...
export const routes: Routes = [
  ...
  { path: 'verification', loadComponent: () => import('./pages/verification.page').then(m => m.VerificationPage) },
  {
    ...
    children: [
      ...
      { path: 'vehicle', redirectTo: 'dashboard' },
      { path: 'pre-trip', redirectTo: 'dashboard' },
      ...
      { path: 'jobs/:jobId/vehicle-confirmation', canActivate:[jobWorkflowGuard], data:{statuses:['assigned']}, loadComponent: () => import('./pages/vehicle.page').then(m => m.VehiclePage) },
      { path: 'jobs/:jobId/pre-job-checklist', canActivate:[jobWorkflowGuard], data:{statuses:['assigned']}, loadComponent: () => import('./pages/pre_trip.page').then(m => m.PreTripPage) },
