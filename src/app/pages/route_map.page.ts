...
@Component({
  ...
  template: `
<wf-mobile-shell title="Navigate to site" subtitle="Job WF-2048" backRoute="/job-details">
  <main class="screen-body stack">
    <section class="map-mock" style="min-height:410px">
      ...
      <ion-card class="wf-card compact" style="position:absolute;z-index:3;left:14px;right:14px;bottom:14px;margin:0">
        <ion-card-content>
          <div class="row-between"><div><strong>18 min · 8.4 miles</strong><p class="caption" style="margin:4px 0 0">ETA 9:07 AM · Light traffic</p></div><span class="pill success">On time</span></div>
        </ion-card-content>
      </ion-card>
    </section>
