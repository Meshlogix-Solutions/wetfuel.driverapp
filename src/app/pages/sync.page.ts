...
<wf-mobile-shell title="Sync center" subtitle="Offline data" backRoute="/dashboard">
  <main class="screen-body stack">
      ...
      <ion-card-content>
        <div class="row-between">
          <div>
            ...
            <p class="caption" style="margin:0">Last successful sync at 9:20 AM.</p>
          </div>
    ...
    <ion-card class="wf-card warning-card"><ion-card-content><strong>Conflict handling</strong><p class="caption" style="margin:6px 0 0">Records with server conflicts remain on the device and are flagged for manager review. Nothing is silently discarded.</p></ion-card-content></ion-card>
  </main>
</wf-mobile-shell>
  `
})
